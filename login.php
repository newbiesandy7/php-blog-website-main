...
<head>
    ...
    <style>
        ...
        body {
            ...
            background-color: var(--background-light); /* Muted Green background as requested */
        ...
        /* Custom button styling (Login button changed to Vibrant Yellow) */
        .btn-custom-primary {
            background-color: var(--highlight-color); /* Vibrant Yellow as requested */
            border-color: var(--highlight-color);
            color: var(--dark-accent); /* Dark text for contrast on yellow */
            transition: background-color 0.3s ease, border-color 0.3s ease;
            border-radius: 0.5rem; /* Bootstrap's default is often smaller */
            padding: 0.75rem 1.5rem; /* Make button larger */
            font-weight: 600;
        }
        ...
        .link-custom-secondary {
            color: var(--primary-color); /* Muted Green */
            text-decoration: none;
            transition: color 0.3s ease;
        }

        .link-custom-secondary:hover {
            color: var(--dark-accent); /* Dark Forest Green on hover */
        }

        /* Form control focus effect */
        .form-control:focus {
            border-color: var(--vibrant-yellow); /* Vibrant Yellow border on focus */
            box-shadow: 0 0 0 0.25rem rgba(255, 186, 0, 0.25); /* Subtle shadow on focus */
        }

        /* Heading color */
        .display-4, .fs-1 {
            color: var(--dark-accent); /* Dark Forest Green for heading */
        }
...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center vh-100 p-3">
        <form class="shadow w-450 p-4 rounded-xl"
            ...
            <div class="logo-section">
                ...
                <img src="img/logo_wobg.png" alt="Company Logo" class="img-fluid">
            </div>

            <h4 class="display-4 fs-1 text-center mb-5">LOGIN</h4>

            <!-- Error Message Placeholder (PHP logic) -->
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center">
                ...
                <div class="d-flex flex-wrap justify-content-center justify-content-sm-end gap-3">
                    <a href="admin-login.php" class="link-custom-secondary">Admin Login</a>
                    <a href="blog.php" class="link-custom-secondary">Blog</a>
                    <a href="signup.php" class="link-custom-secondary">Sign Up</a>
                </div>
            </div>
        </form>
    </div>
