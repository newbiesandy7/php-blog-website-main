...
<head>
    ...
    <style>
        ...
        body {
            ...
            background-color: var(--background-light); /* Muted Green background */
        ...
        /* Custom button styling (Sign Up button will be Vibrant Yellow) */
        .btn-custom-primary {
            background-color: var(--highlight-color); /* Vibrant Yellow */
    ...
    <div class="d-flex justify-content-center align-items-center vh-100 p-3">
        ...
        <form class="shadow w-450 p-4 rounded-xl"
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center">
                <button type="submit" class="btn btn-custom-primary mb-3 mb-sm-0 w-100 w-sm-auto">Sign Up</button>
                <a href="login.php" class="link-custom-secondary">Login</a>
            </div>
        </form>
    </div>
