       ...
       if ($error === 0) {
           if ($image_size > 130000) {
              ...
              if (in_array($image_ex, $allowed_exs )) {
                  ...
                  $sql = "INSERT INTO post(user_id,post_title, post_text,category_id, cover_url) VALUES ($user_id,?,?,?,?)";
          ...
          $sql = "INSERT INTO post(user_id,post_title, post_text, category) VALUES ($user_id,?,?,?)";
          $stmt = $conn->prepare($sql);
